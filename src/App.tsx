    ...
    const home = (
        <>
            <header className="py-24 px-6 text-center">
                ...
                <p className="z-10 text-xl md:text-2xl text-[#86868b] max-w-2xl mx-auto">Click a Project to View The Source Code And Demo It.</p>
                <p className="z-10 text-xl md:text-2xl text-[#86868b] max-w-2xl mx-auto">This Website is Currently Undergoing an Overhaul of The Available Projects</p>
